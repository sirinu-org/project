...
<style type="text/css">#answer{margin-left: 1000%;}</style>
                          ...
                          <script type="text/javascript">
                                function abririnfo() {
                                x=document.getElementById("important");
          ...
          <script>
            ...
            var btns = header.getElementsByClassName("question");
                          ...
                          <div class="quickLinks">
                               <ul class="links" style="list-style: none;">
                                        ...
                                        <br>
                                          ...
                                          <li> <a href="#">Sirinu Token</a></li>
                                </ul>
                          </div>

                      <div class="quickContacts" style="margin-right: 10%">
                         <h1>Follow us</h1>
